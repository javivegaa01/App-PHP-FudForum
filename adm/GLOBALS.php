...
**/
	...
	$GLOBALS['INCLUDE'] 		= '/var/www/FUDForum/include/';
	$GLOBALS['WWW_ROOT'] 		= 'http://www.javiervega-fudforum.org/';
	$GLOBALS['WWW_ROOT_DISK']	= '/var/www/FUDForum/';
	$GLOBALS['DATA_DIR']		= '/var/www/FUDForum/';
	$GLOBALS['ERROR_PATH'] 		= '/var/www/FUDForum/errors/';
	$GLOBALS['MSG_STORE_DIR']	= '/var/www/FUDForum/messages/';
	$GLOBALS['TMP']			= '/var/www/FUDForum/tmp/';
	$GLOBALS['FILE_STORE']		= '/var/www/FUDForum/files/';
	$GLOBALS['FORUM_SETTINGS_PATH'] = '/var/www/FUDForum/cache/';
	$GLOBALS['PLUGIN_PATH'] 	= '/var/www/FUDForum/plugins/';
	...
	$GLOBALS['COOKIE_PATH']		= '/';
	$GLOBALS['COOKIE_DOMAIN']	= '.javiervega-fudforum.org';
	$GLOBALS['COOKIE_NAME']		= 'fud_session_1637517686';
	...
	$GLOBALS['DBHOST_USER']		= 'user-forum';
	$GLOBALS['DBHOST_PASSWORD']	= 'password';
	$GLOBALS['DBHOST_DBNAME']	= 'FUDforum';
	...
	$GLOBALS['ADMIN_EMAIL'] 	= 'www-data@www.javiervega-fudforum.org';
	...
	$GLOBALS['NOTIFY_FROM']		= 'www-data@www.javiervega-fudforum.org';		/* email */
