...
}function alt_var($key)
{
	...
	ses_update_status($usr->sid, 'Recorriendo las suscripciones propias');
...
<tr>
	...
	<td class="nw"><a href="/index.php?t=subscribed&amp;frm_id='.$r[0].'&amp;'._rsid.'&amp;SQ='.$GLOBALS['sq'].'">Desuscribir</a></td>
	...
	<td class="nw"><a href="/index.php?t=subscribed&amp;th='.$r[0].'&amp;'._rsid.'&amp;SQ='.$GLOBALS['sq'].'">Desuscribir</a></td>
...
<tr>
	<th colspan="3">Foros suscritos<a name="fff"></a></th>
</tr>
<?php echo ($subscribed_forum_data ? '
'.$subscribed_forum_data.'
<tr class="RowStyleC">
	<td class="ac" colspan="2"><input type="submit" class="button" name="f_unsub_sel" value="Desuscribir" /></td>
	<td class="ar"><input type="submit" class="button" name="f_unsub_all" value="Desuscribir de todos los foros" /></td>
</tr>
' : '
<tr class="'.alt_var('search_alt','RowStyleA','RowStyleB').'">
	<td colspan="3">No hay foros suscritos</td>
</tr>
'); ?>
<tr>
	<th colspan="3">Hilos de discusión suscritos</th>
</tr>
<?php echo ($subscribed_thread_data ? '
'.$subscribed_thread_data.'
<tr class="RowStyleC">
	<td class="ac" colspan="2"><input type="submit" class="button" name="t_unsub_sel" value="Desuscribir" /></td>
	<td class="ar"><input type="submit" class="button" name="t_unsub_all" value="Desuscribir de todos los hilos" /></td>
</tr>
' : '
<tr class="'.alt_var('search_alt','RowStyleA','RowStyleB').'">
	<td colspan="3">No hay hilos de discusión suscritos</td>
</tr>
'); ?>
</table>
</form>
