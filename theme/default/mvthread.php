...
<tr>
	<td class="small">
		¿Por qué desea que el hilo de discusión se traslade?<br />
		<textarea name="reason_msg" rows="7" cols="30"></textarea>
	</td>
</tr>
<tr>
	<td class="ar"><input type="submit" class="button" name="submit" value="Enviar solicitud" /></td>
</tr>';
		}
	}
	...
	<td style="padding-left: '.$tabw.'px"><a href="/index.php?t=mvthread&amp;th='.$thr->id.'&amp;to='.$r[1].'&amp;'._rsid.'&amp;SQ='.$GLOBALS['sq'].'">'.$r[0].'</a></td>
				...
				$table_data .= '<tr>
	<td style="padding-left: '.$tabw.'px">'.$r[0].' [<a href="/index.php?t=mvthread&amp;th='.$thr->id.'&amp;'._rsid.'&amp;thx='.$r[1].'&amp;SQ='.$GLOBALS['sq'].'">solicitar el traslado</a>]</td>
</tr>';
			}
		}
		unset($c);
...
<tr>
	<td class="small">Trasladar el hilo de discusión <b><?php echo $thr->subject; ?></b> a:</td>
</tr>
<?php echo $table_data; ?>
</table>
<?php echo _hs; ?>
