...
<form id="split_th" action="/index.php?t=split_th" method="post">
<?php echo _hs; ?>
...
<tr class="RowStyleA">
	<td class="al fb">Título del nuevo hilo de discusión:</td>
	<td ><input type="text" spellcheck="true" name="new_title" value="" size="50" /></td>
</tr>
<tr class="RowStyleA">
	<td class="al fb">Foro:</td>
	<td class="al"><select name="forum"><?php echo $forum_sel; ?></select></td>
</tr>
<tr class="RowStyleC">
	<td colspan="2" class="ac">
		<input type="submit" class="button" name="btn_selected" value="Separar mensajes seleccionados" />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="submit" class="button" name="btn_unselected" value="Separar mensajes no seleccionados" />
	</td>
</tr>
</table>
<br />
<table cellspacing="1" cellpadding="2" class="ContentTable">
<tr>
	<th class="nw">Seleccionar</th>
	<th width="100%">Mensajes</th>
</tr>
<?php echo $msg_entry; ?>
</table>
<br />
