...
function reverse_nl2br($data)
{
	...
	<td>
		<b>Categoría</b> '.$obj->cat_name.' :: 
		<b>Foros</b> '.$obj->frm_name.' &nbsp;
		[<a href="/index.php?t=modque&amp;appr='.$obj->id.'&amp;'._rsid.'&amp;SQ='.$GLOBALS['sq'].'">Aprobar</a>]&nbsp;
		[<a href="/index.php?t=modque&amp;del='.$obj->id.'&amp;'._rsid.'&amp;SQ='.$GLOBALS['sq'].'">Borrar</a>]&nbsp;
		[<a href="/index.php?t=modque&amp;delall='.$obj->id.'&amp;'._rsid.'&amp;SQ='.$GLOBALS['sq'].'">Borrar todo del usuario</a>]
	</td>
</tr>
'.tmpl_drawmsg($obj, $usr, $perms, false, $m_num, null);
	...
	if (!$modque_message) {
		$modque_message = '<tr class="RowStyleA"><td>No hay mensajes pendientes de aprobación</td></tr>';
	}
...
<tr>
	<th>Mensajes pendientes de aprobación</th>
</tr>
