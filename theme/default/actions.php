...
function make_perms_query(&$fields, &$join, $fid='')
{
	...
	ses_update_status($usr->sid, 'Espiando a otros usuarios como usted');
	...
	while ($r = db_rowarr($c)) {
		...
		if ($r[3]) {
			...
			if (!$r[10]) {
				...
				$last_post = (!$is_a && !$r[12] && empty($limit[$r[11]])) ? 'No tiene permisos para ver este hilo de discusión.' : strftime('%a, %d %B %Y %H:%M', $r[10]).'
<br />
<a href="/index.php?t='.d_thread_view.'&goto='.$r[8].'&'._rsid.'#msg_'.$r[8].'">'.$r[9].'</a>';
		...
		if (!$r[2] || ($is_a || !empty($limit[$r[2]]) || $r[13])) {
			...
			$action = 'No tiene permisos para ver este hilo de discusión.';
		}
...
<div class="GenText ac">
	[ <a href="/index.php?t=actions&rand=<?php echo get_random_value(); ?>&<?php echo _rsid; ?>" rel="nofollow">Recargar lista</a> ]
	[ <a href="/index.php?t=online_today&amp;<?php echo _rsid; ?>" rel="nofollow">Visitantes de hoy</a> ]
</div>
<br />
<table cellspacing="1" cellpadding="2" class="ContentTable">
<tr>
	<th><a href="/index.php?t=actions&amp;o=alias&amp;s=<?php echo ($o=='u.alias' && $s=='ASC' ? 'd' : 'a'); ?>&amp;<?php echo _rsid; ?>" class="thLnk" rel="nofollow">Usuario</a></th>
	<th>Acción</th>
	<?php echo ($is_a ? '<th><a href="/index.php?t=actions&amp;o=ip&amp;s='.($o=='s.time_sec' && $s=='ASC' ? 'd' : 'a' )  .'&amp;'._rsid.'" class="thLnk" rel="nofollow">IP</a></th>' : '' )  .'
	<th><a href="/index.php?t=actions&amp;o=time&amp;s='.($o=='s.time_sec' && $s=='ASC' ? 'd' : 'a'); ?>&amp;<?php echo _rsid; ?>" class="thLnk" rel="nofollow">Hora</a></th>
...
<?php
	...
	q('UPDATE fud30_stats_cache SET most_online='. $uc .', most_online_time='. __request_timestamp__ .' WHERE most_online < '. $uc);
?>
