...
' : ''); ?>
<?php echo (_uid ? '<div class="SmallText ar">[ <a href="/index.php?t=markread&amp;'._rsid.'&amp;SQ='.$GLOBALS['sq'].'&amp;cat='.$cat_id.'" title="Todos sus mensajes no leídos serán marcados como leídos">Marcar todos los mensajes como leídos</a> ]
...
<tr class="SmallText">
	...
	<td>
		&nbsp;<br />
		<input type="submit" class="button" name="quick_login_submit" value="Iniciar sesión:" />
	</td>
</tr>
</table>
</form>
...
<img src="/theme/default/images/new_content.png" alt="Hay mensajes nuevos desde la última lectura" width="30" height="30" /> Hay mensajes nuevos desde la última lectura&nbsp;&nbsp;
<img src="/theme/default/images/existing_content.png" alt="No hay mensajes nuevos desde la última lectura" width="30" height="30" /> No hay mensajes nuevos desde la última lectura&nbsp;&nbsp;
<img src="/theme/default/images/moved.png" alt="Redirección" width="30" height="30" /> Redirección
</fieldset>
<div><br /></div>
...
<?php echo $page_stats; ?>
<script>
	min_max_cats("/theme/default/images", "Minimizar categoría", "Maximizar categoría", "<?php echo $usr->sq; ?>", "<?php echo s; ?>");
</script>
