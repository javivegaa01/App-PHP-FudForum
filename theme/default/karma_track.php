...
function logaction($user_id, $res, $res_id=0, $action=null)
{
	...
	<td><a href="/index.php?t=karma_track&amp;msgid='.$r[3].'&amp;karmaid='.$r[2].'&amp;'._rsid.'&amp;SQ='.$GLOBALS['sq'].'">Eliminar</a></td>
</tr>';
	}
	unset($c);
...
<tr>
	<td class="small" colspan="4">Administrar la reputación del usuario:</td>
</tr>
<tr>
	<td class="mvTc">Usuario</td>
	<td class="mvTc">Valoración</td>
	<td class="mvTc">Mensaje</td>
	<td class="mvTc">Acción</td>
</tr>
<?php echo $table_data; ?>
<tr>
	<td class="ac RowStyleC" colspan="4">[<a href="javascript://" onclick="window.close();">cerrar ventana</a>]</td>
</tr>
</table>
</div>
</body></html>
