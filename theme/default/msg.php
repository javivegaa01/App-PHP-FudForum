...
}function get_prev_next_th_id($frm_id, $th, &$prev, &$next)
{
	...
	while ($r = db_rowarr($c)) {
		if ($r[2] < $id) {
			...
			$prev = '<tr>
	<td class="ar GenText">Hilo de discusión anterior:</td>
	<td class="GenText al"><a href="/index.php?t='.$_GET['t'].'&amp;goto='.$r[0].'&amp;'._rsid.'#msg_'.$r[0].'">'.$r[1].'</a></td>
			...
			$next = '<tr>
	<td class="GenText ar">Hilo de discusión siguiente:</td>
	<td class="GenText al"><a href="/index.php?t='.$_GET['t'].'&amp;goto='.$r[0].'&amp;'._rsid.'#msg_'.$r[0].'">'.$r[1].'</a></td>
</tr>';
		}		
	}
...
' : '' )  ;
	...
	if (_uid) {
		...
		*/
		...
		$first_unread_message_link = (($total - $th) > $count) ? '| <a href="/index.php?t=msg&amp;unread=1&amp;th='.$th.'&amp;'._rsid.'" title="Ir al primer mensaje no leído de este hilo">Ir a los mensajes no leídos</a>&nbsp;' : '';
		$subscribe_status = $frm->subscribed ? '| <a href="/index.php?t=msg&amp;th='.$th.'&amp;notify='.$usr->id.'&amp;'._rsid.'&amp;opt=off&amp;start='.$_GET['start'].'&amp;SQ='.$GLOBALS['sq'].'" title="Dejar de recibir avisos acerca de nuevos mensajes en este hilo de discusión">Desuscribir del hilo de discusión</a>&nbsp;' : '| <a href="/index.php?t=msg&amp;th='.$th.'&amp;notify='.$usr->id.'&amp;'._rsid.'&amp;opt=on&amp;start='.$_GET['start'].'&amp;SQ='.$GLOBALS['sq'].'" title="Recibir una notificación cuando haya nuevos mensajes en este hilo">Suscribirse al hilo de discusión</a>&nbsp;';
		$bookmark_status  = $frm->bookmarked ? '| <a href="/index.php?t=msg&amp;th='.$th.'&amp;bookmark='.$usr->id.'&amp;'._rsid.'&amp;opt=off&amp;start='.$_GET['start'].'&amp;SQ='.$GLOBALS['sq'].'" title="Quitar este tema de tu lista de favoritos">Quitar de favoritos</a>&nbsp;' : '| <a href="/index.php?t=msg&amp;th='.$th.'&amp;bookmark='.$usr->id.'&amp;'._rsid.'&amp;opt=on&amp;start='.$_GET['start'].'&amp;SQ='.$GLOBALS['sq'].'" title="Agregar este tema a tu lista de marcadores">Tema de marcador</a>&nbsp;';
	} else {
	...
	ses_update_status($usr->sid, 'Recorriendo el hilo de discusión <a href="/index.php?t=msg&amp;th='.$frm->id.'">'.$frm->subject.'</a>', $frm->forum_id);
...
<b>::</b> <a href="/index.php?t=mnav&amp;<?php echo _rsid; ?>" rel="nofollow">Navegador de mensajes</a>
	...
	<br />
	<?php echo (($frm->replies && $perms & 2048) ? '<a href="/index.php?t=split_th&amp;'._rsid.'&amp;th='.$th.'">Dividir el hilo de discusión</a>&nbsp;|&nbsp;' : ''); ?>
	<?php echo (($frm->replies && $perms & 8192) ? '<a href="/index.php?t=movemsg&amp;th='.$th.'">Trasladar mensajes</a>&nbsp;|&nbsp;' : ''); ?>
	<?php echo ($perms & 8192 ? '<a href="javascript://" onclick="window_open(\'/index.php?t=mvthread&amp;'._rsid.'&amp;th='.$th.'\', \'th_move\', 300, 400);">Trasladar</a>&nbsp;|&nbsp;' : ''); ?>
	<?php echo ($perms & 4096 ? ($frm->thread_opt & 1 ? '<a href="/index.php?t=mmod&amp;'._rsid.'&amp;th='.$th.'&amp;unlock=1&amp;SQ='.$GLOBALS['sq'].'">Desbloquear el hilo de discusión</a>&nbsp;|&nbsp;' : '<a href="/index.php?t=mmod&amp;'._rsid.'&amp;th='.$th.'&amp;lock=1&amp;SQ='.$GLOBALS['sq'].'">Bloquear hilo de discusión</a>&nbsp;|&nbsp;'):'').'
	'.($FUD_OPT_2 & 1073741824 ? '<a href="/index.php?t=remail&amp;th='.$th.'&amp;'._rsid.'" title="Enviar la URL de esta página por correo a un amigo" rel="nofollow">Enviar un correo a un amigo</a>&nbsp;' : ''); ?>
	<?php echo $first_unread_message_link.$subscribe_status.$bookmark_status; ?>
</td>
<td class="vb ar">
	<?php echo ($FUD_OPT_3 & 2 ? '' : '<a href="/index.php?t=tree&amp;th='.$th.'&amp;'._rsid.'"><img title="Cambiar a la vista en árbol para este hilo" alt="Cambiar a la vista en árbol para este hilo" src="/theme/default/images/tree_view.gif" width="100" height="25" /></a>&nbsp;'); ?><a href="/index.php?t=post&amp;frm_id=<?php echo $frm->forum_id; ?>&amp;<?php echo _rsid; ?>"><img alt="Crear un nuevo hilo de discusión" src="/theme/default/images/new_thread.gif" width="100" height="25" /></a><?php echo ((!($frm->thread_opt & 1) || $perms & 4096) ? '&nbsp;<a href="/index.php?t=post&amp;th_id='.$th.'&amp;reply_to='.$frm->root_msg_id.'&amp;'._rsid.'&amp;start='.$_GET['start'].'"><img src="/theme/default/images/post_reply.gif" alt="Enviar respuesta" width="100" height="25" /></a>' : ''); ?>
</td>
</tr>
</table>
	...
	<td class="MsgSpacer">
		...
		<tr>
			<td class="MsgR3" '.($quick_reply_collapsed ? 'style="display:none;"' : '' )  .'>
				<table><tr class="RowStyleA"><td class="GenText nw">Herramientas de formato:</td><td class="nw">
	...
	<option value="Century" style="font-family:Century">Century</option>
		...
		<tr>
			<td class="MsgToolBar" '.($quick_reply_collapsed ? 'style="display:none;"' : '' )  .'>
				<input type="submit" accesskey="r" class="button" value="Previsualizar respuesta rápida" tabindex="4" name="preview" />
				<input type="submit" accesskey="s" class="button" tabindex="5" name="btn_submit" value="Publicar respuesta rápida" onclick="javascript: document.post_form.submitted.value=1;" />
			</td>
		</tr>
		</table>
	</td>
...
<tr>
	...
	<td class="GenText ar vb nw">'.($FUD_OPT_3 & 2 ? '' : '<a href="/index.php?t=tree&amp;th='.$th.'&amp;'._rsid.'"><img title="Cambiar a la vista en árbol para este hilo" alt="Cambiar a la vista en árbol para este hilo" src="/theme/default/images/tree_view.gif" width="100" height="25" /></a>&nbsp;'); ?><a href="/index.php?t=post&amp;frm_id=<?php echo $frm->forum_id; ?>&amp;<?php echo _rsid; ?>"><img alt="Crear un nuevo hilo de discusión" src="/theme/default/images/new_thread.gif" width="100" height="25" /></a><?php echo (!$quick_reply_enabled && (!($frm->thread_opt & 1) || $perms & 4096) ? '&nbsp;<a href="/index.php?t=post&amp;th_id='.$th.'&amp;reply_to='.$frm->root_msg_id.'&amp;'._rsid.'&amp;start='.$_GET['start'].'"><img src="/theme/default/images/post_reply.gif" alt="Enviar respuesta" width="100" height="25" /></a>' : ''); ?></td>
</tr>
</table>
...
<select class="SmallText" onchange="if (this.value) topicVote(this.value, '.$frm->id.', \''.s.'\', \''.$usr->sq.'\');">
	<option>Evaluar hilo de discusión</option>
...
<script>
	...
	format_code('Código:', 'Seleccionar todo', 'Mostrar/ocultar');
