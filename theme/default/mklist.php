...
function addOption()
{
	...
	dl.appendChild(document.createTextNode('Borrar'));
...
<tr>
	...
	<td>
		<select name="tp" onchange="changeListType(this.options[this.selectedIndex].value);">
			...
			<option value="square"<?php echo ($def_list_type == 'square' ? ' selected="selected"' : ''); ?>>Cuadrado</option>
...
<tr>
	...
	<td class="nw">
		...
		<input tabindex="2" type="button" class="button" name="btn_submit" onclick="addOption();" value="Añadir elemento" />
	</td>
</tr>
<tr>
...
<tr>
	<td colspan="2" class="ar">
		<input type="button" class="button" name="go" value="Aplicar" onclick="updatePostForm();" />
		<input type="button" class="button" name="close" value="Cerrar" onclick="window.close();" />
	</td>
</tr>
</table>
</form>
