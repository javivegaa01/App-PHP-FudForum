...
function fud_whois($ip)
{
	...
	return ($result ? $result : 'La información de whois para <b>'.$ip.'</b> no está disponible.');
}
...
<tr>
	<td class="vt">
		...
		<tr><th>Usuarios que usan la dirección IP &#39;'.$ip.'&#39;</th></tr>'.$user_list.'
		</table>
	</td>
	<td width="50"> </td>
	<td class="vt"><b>Información del ISP</b><br /><div class="ip"><pre>'.fud_whois($ip).'</pre></div></td>
</tr>
</table>';
	} else if ($user) {
