...
<tr>
	...
	$TITLE_EXTRA = ': Mostrar mensajes de: '.$u_alias;

	ses_update_status($usr->sid, 'Viendo mensajes de: <a href="/index.php?t=usrinfo&amp;id='.$uid.'">'.$u_alias.'</a>');
...
<tr>
	<th colspan="3">Información del usuario</th>
</tr>
<tr class="RowStyleA">
	<td class="GenText wa">Iniciar sesión: <a href="/index.php?t=usrinfo&amp;id=<?php echo $uid; ?>&amp;<?php echo _rsid; ?>"><?php echo filter_var($u_alias, FILTER_SANITIZE_STRING); ?></a></td>
	<td class="GenText nw">Registrado el <?php echo strftime('%a, %d %B %Y', $u_reg_date); ?></td>
	<td class="GenText nw">Total de Mensajes <?php echo $u_pcount; ?></td>
</tr>
<tr>
	<th class="wa">Asunto</th>
	<th class="nw">Foro:</th>
	<th class="nw"><a class="thLnk" href="/index.php?t=showposts&amp;so=<?php echo $SORT_ORDER_R; ?>&amp;id=<?php echo $uid; ?>&amp;<?php echo _rsid; ?>" rel="nofollow">Fecha de publicación</a></th>
</tr>
<?php echo $post_entry; ?>
</table>
<?php echo $pager; ?>
