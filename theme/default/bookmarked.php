...
}function alt_var($key)
{
	...
	ses_update_status($usr->sid, 'Explorando tu propia lista de marcadores');
...
<tr>
	...
	<td class="nw"><a href="/index.php?t=bookmarked&amp;th='.$r[0].'&amp;'._rsid.'&amp;SQ='.$GLOBALS['sq'].'">Quitar de favoritos</a></td>
...
<tr>
	<th colspan="3">Tópicos en marcadores</th>
</tr>
<?php echo ($bookmarked_thread_data ? '
'.$bookmarked_thread_data.'
<tr class="RowStyleC">
	<td class="ac" colspan="2"><input type="submit" class="button" name="t_unbookmark_sel" value="Quitar de favoritos" /></td>
	<td class="ar"><input type="submit" class="button" name="t_unbookmark_all" value="Eliminar todos los marcadores" /></td>
</tr>
' : '
<tr class="'.alt_var('search_alt','RowStyleA','RowStyleB').'">
	<td colspan="3">Sin tópicos en marcadores</td>
</tr>
'); ?>
</table>
</form>
