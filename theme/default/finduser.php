...
}function draw_user_link($login, $type, $custom_color='')
{
	...
	$TITLE_EXTRA = ': Encontrar usuario';

	ses_update_status($usr->sid, 'Buscando usuarios');
...
if (_uid) {
	...
	<td class="nw GenText"><a href="/index.php?t=usrinfo&amp;id='.$r->id.'&amp;'._rsid.'">'.draw_user_link($r->alias, $r->users_opt, $r->custom_color).'</a>'.($r->users_opt & 131072 ? '' : '&nbsp;&nbsp;(usuario sin confirmar)' ) .'</td>
	<td class="ac nw hide2">'.$r->posted_msg_count.'</td>
        <td class="DateText nw hide2">'.strftime('%a, %d %B %Y', $r->join_date).'</td>
        <td class="nw GenText"><a href="/index.php?t=showposts&amp;id='.$r->id.'&amp;'._rsid.'"><img alt="" src="/theme/default/images/show_posts.gif" /></a>
...
'.($r->home_page ? '<a href="'.$r->home_page.'" rel="nofollow"><img alt="" src="/theme/default/images/homepage.gif" /></a>' : '' ) .'</td>
	...
	<a href="/adm/admuser.php?usr_id='.$r->id.'&amp;S='.s.'&amp;act=1&amp;SQ='.$GLOBALS['sq'].'">Editar</a> ||
	<a href="/adm/admuser.php?usr_id='.$r->id.'&amp;S='.s.'&amp;act=del&amp;f=1&amp;SQ='.$GLOBALS['sq'].'">Borrar</a> ||
	'.($r->users_opt & 65536 ? '<a href="/adm/admuser.php?act=block&amp;usr_id='.$r->id.'&amp;S='.s.'&amp;SQ='.$GLOBALS['sq'].'">No expulsado</a>' : '<a href="/adm/admuser.php?act=block&amp;usr_id='.$r->id.'&amp;S='.s.'&amp;SQ='.$GLOBALS['sq'].'">Expulsado</a>' ) .'
</td>' : '' ) .'
</tr>';
	}
	unset($c);
	...
	<td colspan="'.($is_a ? '5' : '4' )  .'" class="wa GenText">No existe el usuario</td>
</tr>';
	}
...
<tr class="RowStyleA">
	<td class="GenText">Por nombre de usuario:</td>
	<td class="GenText">
		<input type="text" name="usr_login" tabindex="1" value="<?php echo char_fix(htmlspecialchars($usr_login)); ?>" />
		<input type="submit" class="button" tabindex="2" name="btn_submit" value="Encontrar" /></td>
		<td class="RowStyleC SmallText vt">El motor de búsqueda añadirá la máscara * a la consulta. Por ejemplo, para buscar todos los usuarios que empiezan por &#39;a&#39;, introduzca &#39;a&#39; en el cuadro de búsqueda.
	</td>
</tr>
</table>
...
<table cellspacing="1" cellpadding="2" class="ContentTable">
<tr>
	<?php echo ($GLOBALS['FUD_OPT_3'] & 524288 ? '<th width="1"><a class="thLnk" href="/index.php?t=finduser&amp;usr_login='.urlencode($usr_login).'&amp;'._rsid.'&amp;fl='.(isset($_GET['fl']) && !($_GET['fl'] % 2) ? '1' : '2' )  .'&amp;btn_submit=Find" rel="nofollow">Bandera</a></th>' : ''); ?>
	<th class="wa"><a class="thLnk" href="/index.php?t=finduser&amp;usr_login=<?php echo urlencode($usr_login); ?>&amp;us=<?php echo (isset($_GET['us']) && !($_GET['us'] % 2) ? '1' : '2' )  .'&amp;btn_submit=Find&amp;'._rsid.'" rel="nofollow">Usuario</a></th>
	<th class="nw hide2"><a href="/index.php?t=finduser&amp;usr_login='.urlencode($usr_login).'&amp;'._rsid.'&amp;pc='.(isset($_GET['pc']) && !($_GET['pc'] % 2) ? '1' : '2' )  .'&amp;btn_submit=Find" class="thLnk" rel="nofollow">Total de mensajes</a></th>
	<th class="nw hide2"><div class="ac"><a href="/index.php?t=finduser&amp;usr_login='.urlencode($usr_login).'&amp;'._rsid.'&amp;rd='.(isset($_GET['rd']) && !($_GET['rd'] % 2) ? '1' : '2' )  .'&amp;btn_submit=Find" class="thLnk" rel="nofollow">Fecha de incorporación</a></div></th>
	<th class="ac">Acción</th>
	'.($is_a ? '<th class="nw">Opciones de administración</th>' : ''); ?>
</tr>
