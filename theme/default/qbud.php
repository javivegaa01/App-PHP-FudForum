...
<tr class="'.alt_var('search_alt','RowStyleA','RowStyleB').'">
	<td colspan="2" class="GenText ar"><input type="submit" class="button" name="submit" value="Agregar seleccionado(a)" /></td>
</tr>' : '<tr class="RowStyleA">
	<td class="GenText ac">No hay amigos de los cuales escoger</td>
</tr>'); ?>
</table>
</form>
</div>
