...
<a href="/index.php?t='.d_thread_view.'&amp;goto='.$r[5].'&amp;'._rsid.'#msg_'.$r[5].'">'.$r[6].'</a>';
			...
			$last_post = 'No tiene permisos para ver este hilo de discusión.';
		}
...
<tr>
	...
	<th><a href="/index.php?t=online_today&amp;<?php echo _rsid; ?>&amp;o=last_visit&amp;s=<?php echo ($o=='u.last_visit' && $s=='ASC' ? 'd' : 'a'); ?>&amp;<?php echo _rsid; ?>" class="thLnk" rel="nofollow">Última visita</a></th>
