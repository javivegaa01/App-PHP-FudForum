...
}function tmpl_draw_select_opt($values, $names, $selected)
{
	...
	$TITLE_EXTRA = ': Formulario de selección de avatares';
	...
	<input type="submit" name="sbm" value="Actualizar" />
</form>
<hr />';
	} else {
		$gal = 'default';
...
<span class="SmallText">'.$r[1].'</span></a>
	...
	if (!$avatars_data) {
		$avatars_data = '<td class="NoAvatar">No hay avatares disponibles</td>';
	}
