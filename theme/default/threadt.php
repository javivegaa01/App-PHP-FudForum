...
function make_perms_query(&$fields, &$join, $fid='')
{
	...
	if (!($FUD_OPT_2 & 512)) {
		error_dialog('La vista en árbol de los hilos ha sido desactivada.', 'El administrador ha desactivado la vista de árbol del listado de hilos. Por favor, use la vista plana en su lugar.');
	}

	ses_update_status($usr->sid, 'Navegando por el foro (vista en árbol) <a href="/index.php?t=threadt&amp;frm_id='.$frm->id.'">'.$frm->name.'</a>', $frm->id);
...
function draw_forum_path($cid, $fn='', $fid=0, $tn='')
{
							...
							if ($TREE_THREADS_MAX_DEPTH > $lev) {
								...
								if (_uid) {
									if ($usr->last_read < $cur->post_stamp && $cur->post_stamp>$cur->last_view) {
										$thread_read_status = $cur->thread_opt & 1 ? '<img src="/theme/default/images/unreadlocked.png" title="Hilo de discusión bloqueado con mensajes no leídos" alt="" width="22" height="22"  />'	: '<img src="/theme/default/images/unread.png" title="Este hilo contiene mensajes que aún no ha leído" alt="" width="22" height="22" />';
									} else {
										$thread_read_status = $cur->thread_opt & 1 ? '<img src="/theme/default/images/readlocked.png" title="Este hilo de discusión se ha bloqueado" alt="" width="22" height="22" />' : '<img src="/theme/default/images/read.png" title="Este hilo de discusión no tiene mensajes no leídos" alt="" width="22" height="22" />';
									}
								} else {
									$thread_read_status = $cur->thread_opt & 1 ? '<img src="/theme/default/images/readlocked.png" title="Este hilo de discusión se ha bloqueado" alt="" width="22" height="22" />' : '<img src="/theme/default/images/read.png" title="Sólo los usuarios registrados pueden hacer seguimiento de mensajes leídos y no leídos" alt="" width="22" height="22" />';
								}
	...
	<td title="'.$cur->tdescr.'" class="tt" style="padding-left: '.(20 * ($lev - 1)).'px">
		...
		'.(($lev == 1 && $cur->thread_opt > 1) ? ($cur->thread_opt & 4 ? '<span class="StClr"> (fijo)</span>' : '<span class="AnClr"> (anuncio)</span>' ) : '' ) .'
	...
	<td class="tt" style="padding-left: '.($width += 20).'px"><a href="/index.php?t='.d_thread_view.'&amp;goto='.$cur->id.'&amp;'._rsid.'#msg_'.$cur->id.'" class="big">&lt;más&gt;</a></td>
</tr>';
							}
...
<b>::</b> <a href="/index.php?t=mnav&amp;<?php echo _rsid; ?>" rel="nofollow">Navegador de mensajes</a>
	...
	<td class="GenText nw vb ar"><a href="/index.php?t=thread&amp;frm_id=<?php echo $frm->id; ?>&amp;<?php echo _rsid; ?>"><img alt="Volver a la vista plana predeterminada" title="Volver a la vista plana predeterminada" src="/theme/default/images/flat_view.gif" /></a>&nbsp;<a href="/index.php?t=post&amp;frm_id=<?php echo $frm->id; ?>&amp;<?php echo _rsid; ?>"><img src="/theme/default/images/new_thread.gif" alt="Crear un nuevo hilo de discusión" /></a></td>
</tr>
</table>
...
<?php echo (_uid ? '<div class="ar SmallText">[ <a href="/index.php?t=markread&amp;'._rsid.'&amp;id='.$frm->id.'&amp;SQ='.$GLOBALS['sq'].'" title="Todos los mensajes sin leer dentro de este foro se marcarán como leídos">marcar todos los mensajes sin leer del foro como leídos</a> ]'.($FUD_OPT_2 & 1048576 ? '&nbsp;[ <a href="/index.php?t=help_index&amp;section=boardusage#syndicate">Leer este foro con lector un RSS (XML)</a> ]
[ <a href="/feed.php?mode=m&amp;l=1&amp;basic=1&amp;frm='.$frm->id.'&amp;n=10"><img src="/theme/default/images/rss.gif" title="Leer este foro con lector un RSS (XML)" alt="RSS" width="16" height="16" /></a> ]' : '' ) .(($FUD_OPT_2 & 270532608) == 270532608 ? '&nbsp;[ <a href="/pdf.php?frm='.$frm->id.'&amp;page='.$cur_frm_page.'&amp;'._rsid.'"><img src="/theme/default/images/pdf.gif" title="Generar PDF imprimible" alt="PDF" /></a> ]' : '' )  .'</div>' : '<div class="ar SmallText">'.(($FUD_OPT_2 & 270532608) == 270532608 ? '&nbsp;[ <a href="/pdf.php?frm='.$frm->id.'&amp;page='.$cur_frm_page.'&amp;'._rsid.'"><img src="/theme/default/images/pdf.gif" title="Generar PDF imprimible" alt="PDF" /></a> ]' : '' ) .($FUD_OPT_2 & 1048576 ? '&nbsp;[ <a href="/index.php?t=help_index&amp;section=boardusage#syndicate">Leer este foro con lector un RSS (XML)</a> ]
