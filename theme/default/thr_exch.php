...
}function get_host($ip)
{
	...
	if (isset($_GET['appr']) && ($thrx = thx_get((int)$_GET['appr']))) {
		...
		if (!empty($_POST['reason'])) {
			send_status_update($data->id, $data->login, $data->email, 'Traslado del hilo de discusión '.$data->subject.' al foro '.$data->f2_name.' fue desestimada.', htmlspecialchars($_POST['reason']));
			thx_delete($thrx->id);
			$decl = 0;
		} else {
...
<tr>
	<td class="RowStyleC">Razón para rechazar el ingreso del hilo de discusión <b>'.$data->subject.'</b> en el foro <b>'.$data->f2_name.'</b><br /><textarea name="reason" cols="60" rows="10"></textarea><br /><input type="submit" class="button" name="btn_submit" value="Enviar" /></td>
<tr>
</form>';
		}
...
<tr class="RowStyleB">
	<td class="al nw vt SmallText"><b>Traslado de hilo de discusión solicitada por:</b> <a href="/index.php?t=usrinfo&amp;id='.$obj->req_by.'&amp;'._rsid.'">'.filter_var($obj->alias, FILTER_SANITIZE_STRING).'</a><br /></td>
	<td class="ac wa vt SmallText"><b>Razón del traslado del hilo de discusión:</b><br /><table border="1" cellspacing="1" cellpadding="0"><tr><td class="al">&nbsp;'.$obj->reason_msg.' &nbsp;</td></tr></table></td>
</tr>
<tr class="RowStyleC">
	<td colspan="2">
		<table border="0" cellspacing="0" cellpadding="3" class="wa">
		<tr>
			<td class="al SmallText"><b>Foro de origen:</b> '.$obj->sf_name.'<br /><b>Foro de destino:</b> '.$obj->df_name.'<br /><b>Hilo de discusión:</b> <a href="/index.php?t=msg&amp;'._rsid.'&amp;th='.$obj->th.'">'.$obj->subject.'</a></td>
			<td class="ar">[<a href="/index.php?t=thr_exch&amp;appr='.$obj->id.'&amp;'._rsid.'">aceptar hilo de discusión</a>]&nbsp;&nbsp;[<a href="/index.php?t=thr_exch&amp;decl='.$obj->id.'&amp;'._rsid.'">rechazar hilo de discusión</a>]</td>
		</tr>
		</table>
	</td>
</tr>
		...
		if (!$thr_exch_data) {
			$thr_exch_data = '<tr>
	<td class="RowStyleA ac">No hay hilos de discusión esperando aprobación.</td>
</tr>';
		} else if ($is_a && $thx) {
...
<tr>
	<th>Intercambio de hilos de discusión</th>
</tr>
