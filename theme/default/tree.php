...
' : '' )  ;
	...
	if (_uid) {
		...
		$subscribe_status = $frm->subscribed ? '| <a href="/index.php?t=tree&amp;th='.$th.'&amp;notify='.$usr->id.'&amp;'._rsid.'&amp;opt=off&amp;mid='.$mid.'&amp;SQ='.$GLOBALS['sq'].'" title="Dejar de recibir avisos acerca de nuevos mensajes en este hilo de discusión">Desuscribir del hilo de discusión</a>&nbsp;' : '| <a href="/index.php?t=tree&amp;th='.$th.'&amp;notify='.$usr->id.'&amp;'._rsid.'&amp;opt=on&amp;mid='.$mid.'&amp;SQ='.$GLOBALS['sq'].'" title="Recibir una notificación cuando haya nuevos mensajes en este hilo">Suscribirse al hilo de discusión</a>&nbsp;';
	...
	ses_update_status($usr->sid, 'Recorriendo hilo de discusión (vista en árbol) <a href="/index.php?t=tree&amp;th='.$frm->id.'&amp;'._rsid.'">'.$frm->subject.'</a>', $frm->id);
...
function draw_forum_path($cid, $fn='', $fid=0, $tn='')
{
	...
	if ($perms & 4096) {
		$lock_thread = !($frm->thread_opt & 1) ? '<a href="/index.php?t=mmod&amp;'._rsid.'&amp;th='.$th.'&amp;lock=1&amp;SQ='.$GLOBALS['sq'].'">Bloquear hilo de discusión</a>&nbsp;|&nbsp;' : '<a href="/index.php?t=mmod&amp;'._rsid.'&amp;th='.$th.'&amp;unlock=1&amp;SQ='.$GLOBALS['sq'].'">Desbloquear el hilo de discusión</a>&nbsp;|&nbsp;';
	} else {
		$lock_thread = '';
	}
	...
	<td>'.((_uid && $cur->post_stamp > $usr->last_read && $cur->post_stamp > $frm->last_view) ? '<img id="msgIm'.$cur->id.'" src="/theme/default/images/unread.png" alt="Mensaje no leído" title="Mensaje no leído" width="22" height="22" />' : '<img src="/theme/default/images/read.png" alt="Leer mensaje" title="Leer mensaje" width="22" height="22" />' ) .'</td>
...
<div class="ac GenText">[<a href="javascript://" onclick="chng_focus('tree_view');" title="Ver la lista de mensajes">Índice de mensajes</a>]</div>
<a name="tree_view">&nbsp;</a>
