...
if (_uid) {
	...
	<td class="RowStyleA">
		...
		<tr class="RowStyleB">
			<td class="SmallText">
				<b>Mensaje de:</b> '.($r->alias ? filter_var($r->alias, FILTER_SANITIZE_STRING).'' : $anon_alias.'' )  .'<br />
				<b>Publicado el:</b> '.strftime('%a, %d %B %Y %H:%M', $r->post_stamp).'<br />
				<b>Asunto:</b> '.$r->subject.'
			</td>
		</tr>
		<tr class="RowStyleA">
...
<form id="movemsg" action="/index.php?t=movemsg" method="post"><?php echo _hs; ?><input type="hidden" name="th" value="<?php echo $th; ?>" />
<table cellspacing="1" cellpadding="2" class="ContentTable">
<tr>
	<th class="wa" colspan="2">Panel de control para separar hilos</th>
</tr>
<tr class="RowStyleA">
	<td class="al fb">Especificar el id. del tema de destino (puede estar en otros foros)</td>
	<td class="al"><input type="text" value="" name="dest_th" /></td>
</tr>
<tr class="RowStyleC">
	<td colspan="2" class="ac"><input type="submit" class="button" name="btn_selected" value="Trasladar mensajes seleccionados" /></td>
</tr>
</table>
<br />
<table cellspacing="1" cellpadding="2" class="ContentTable">
<tr>
	<th class="nw">Seleccionar</th><th width="100%">Mensajes</th>
</tr>
<?php echo $msg_entry; ?>
</table>
<br />
