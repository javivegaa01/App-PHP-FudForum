...
<tr>
	<th class="wa" colspan="2">Panel para unir hilos de discusión</th>
</tr>
<?php echo (isset($new_th) ? '<tr  class="RowStyleA">
	<td colspan="2" class="al"><b>Ir al <a href="/index.php?t=msg&amp;'._rsid.'&amp;th='.$new_th.'">último hilo combinado</a> o combine otro:</b></td>
</tr>' : ''); ?>
<tr class="RowStyleA">
	<td class="al"><b>Título del nuevo hilo de discusión:</b></td>
...
<tr class="RowStyleC">
	<td colspan="2" class="ac">
		<table border="0" cellspacing="1" cellpadding="2">
			<tr><td colspan="3" class="ac">Seleccione los hilos que se van a unir <font class="SmallText">(debe selecionar más de 1 hilo)</font></td></tr>
			<tr><td colspan="3" class="ac">Seleccionar la página del hilo: 
			...
			<tr>
				<td class="al" width="100">
					<?php echo ($page > 1 ? '<input type="submit" name="prev" value="Hilo anterior" />' : ''); ?>
				</td>
				<td class="ac" width="200"><input type="submit" name="merge" value="Unir los hilos seleccionados" /></td>
				<td class="ar" width="100">
					<?php echo ($page < $max_p ? '<input type="submit" name="next" value="Hilos siguientes" />' : ''); ?>
				</td>
			</tr>
		</table>
	</td>
